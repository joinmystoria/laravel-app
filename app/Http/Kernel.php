...
class Kernel extends HttpKernel
{
     ...
     *
     * These middleware groups may be assigned to routes by using the "middleware" method.
     *
     * @var array
     */
    ...
    protected $routeMiddleware = [
        ...
        'cors' => \App\Http\Middleware\CorsMiddleware::class, // CORS middleware registered for routes
    ];
}
